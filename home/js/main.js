...
function selectDoc(prod_id, doc_id) {
    ...
    switch (prod_id) {
        ...
        case 'btn-ehs': // Enterprise Home Screen
            ...
            doc = $("#ehs-doc").val();
            break;
        case 'btn-idguardian': // Identity Guardian
            ver = $("#idguardian-version").val();
            doc = $("#idguardian-doc").val();
            break;
        ...
        case 'btn-ssm':
            ...
            break;
        case 'btn-ti':
            ver = $("#tread-intel-version").val();
            doc = $("#tread-intel-doc").val();
            break;
        case 'btn-uhm':
            ver = $("#uhm-version").val();
            doc = $("#uhm-doc").val();
...
function populateDropdown (ddl_ver, ddl_doc) {
    ...
    // Tread Intel
    var ti_1_0_text = ['About', 'API'];
    var ti_1_0_val = ['/guide/about', '/guide/api'];
    // VAS-SDK
    ...
    switch (ddl_ver.value) {
        ...
        case '/deviceguardian/2-5':
        case '/deviceguardian/2-6':
        case '/deviceguardian/2-7':
            ddl_doc.options.length = 0;
        ...
        case '/ehs/5-0':
            ...
            break;        
        // Identity Guardian
        case '/identityguardian/1-0':
        case '/identityguardian/1-1':
        case '/identityguardian/1-2':
            ddl_doc.options.length = 0;
        ...
        case '/identityguardian/1-7':
        case '/identityguardian/2-0':
        case '/identityguardian/2-1':
        case '/identityguardian/2-2':
        ...
        case '/stagenow/5-9':
            ...
            break;
        // Tread Intel
        case '/tread-intel/1-0':        
            ddl_doc.options.length = 0;
            for (i=0; i < ti_1_0_text.length; i++) {
                createOption(ddl_doc, ti_1_0_text[i], ti_1_0_val[i]);
            }
            break;
        // VAS SDK
        case '/vas-sdk/1-0':
